      ...
      <PublicLayout>
        <div className="min-h-[60vh] flex items-center justify-center">
          <div className="text-center">
            <div className="w-10.5 h-10.5 mx-auto mb-4.5 rounded-full border-[3px] border-line border-t-brand animate-spin [animation-duration:0.85s]" />
    ...
    <PublicLayout>
      <div className="bg-[#f5f1e9] min-h-screen pb-20">
        ...
        <div className="bg-[#f9f6f1] border-b border-[#e6d9c9]">
          <div className="max-w-285 mx-auto px-4 py-3.25">
            <Link
              to="/blog"
              className="inline-flex items-center gap-2.25 text-[0.83rem] text-[#5c4630] hover:text-ink no-underline font-medium py-1 transition-colors"
            >
        ...
        <div className="max-w-195 mx-auto px-5 pb-15">
          <div className="border-t border-[#e6d9c9] pt-6 flex items-center justify-between flex-wrap gap-3.5">
            <Link to="/blog" className="text-brand-dark font-semibold text-[0.93rem] no-underline inline-flex items-center gap-1.75">
              ← Xem thêm bài viết khác
            </Link>

            <button
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              className="bg-transparent hover:bg-[#f9f6f1] border border-[#d4c5af] hover:border-brand text-brand-dark px-4.5 py-2 rounded-full text-[0.81rem] font-semibold cursor-pointer transition-colors"
            >
              Lên đầu trang ↑
            </button>
          </div>
