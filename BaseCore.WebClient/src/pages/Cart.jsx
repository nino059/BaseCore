    ...
    <PublicLayout cartCount={count}>
      <div className="container py-4">
        <h3 className="mb-4" style={{ fontWeight: 700 }}>
          ...
          Giỏ hàng của bạn
          {count > 0 && <span className="badge badge-pill ml-2"
            style={{ background: '#a78bfa', color: 'white', fontSize: '0.8rem' }}>{count}</span>}
        </h3>
        ...
        {items.length === 0 ? (
          ...
          <div className="row">
                ...
                {items.map((item, idx) => (
                  <div key={item.id} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontWeight: 600, fontSize: '0.95rem', marginBottom: 2 }}>{item.name}</div>
                      {item.categoryName && (
                        <span style={{
                      ...
                      <div style={{ color: '#ef4444', fontWeight: 700, marginTop: 4 }}>{fmt(item.price)}</div>
                    </div>
                    ...
                    {/* Thành tiền */}
                    <div style={{ fontWeight: 700, color: '#1f2937', minWidth: 90, textAlign: 'right', flexShrink: 0 }}>
            ...
            <div className="col-lg-4">
              <div style={{ background: 'white', borderRadius: 16, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', padding: 24 }}>
                <h6 style={{ fontWeight: 700, marginBottom: 20 }}>Tóm tắt đơn hàng</h6>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12, color: '#6b7280' }}>
