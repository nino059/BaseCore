...
// Chỉ 3 trạng thái có thể xuất hiện trong đơn hàng thực tế
const PRODUCT_STATUS_MAP = {
  ForSale: { label: 'Đang bán', bg: '#d1fae5', color: '#065f46' },
  Ordered: { label: 'Đã đặt',   bg: '#dbeafe', color: '#1e40af' },
  Sold:    { label: 'Đã bán',   bg: '#f3f4f6', color: '#6b7280' },
};
