      ...
      <nav style={{
        ...
        <div className="container" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 18, marginLeft: 'auto' }}>
            ...
            {/* Mobile hamburger */}
            <button className="d-lg-none" onClick={() => setNavOpen(o => !o)}
        ...
        {/* Mobile menu */}
        {navOpen && (
          <div className="d-lg-none" style={{ background: 'rgba(20,16,12,0.98)', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
